...
// ─── Per-platform onboarding guidance ─────────────────────────────────────────
// The PLATFORM_GUIDE / RUNTIMES tables + their types live in platform-guide.ts (pure prose
// data, kept out of this decision-logic core). Re-exported here so existing importers of
// lib.ts are unchanged.
export {
  RUNTIMES,
  PLATFORM_GUIDE,
  pollModeSecrets,
