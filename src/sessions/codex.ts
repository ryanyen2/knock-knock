/**
 * Codex (OpenAI) session reader. Layout: `~/.codex/sessions/YYYY/MM/DD/*.jsonl`
 * rollouts (plus older flat layouts), often `payload`-wrapped; format varies, so
 * probe common field names and skip what isn't recognized. cwd from session_meta.
 */
